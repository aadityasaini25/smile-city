        ...
        <div className="p-6 md:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex justify-center items-center px-6 py-3 text-white font-medium rounded-lg transition-colors gap-2"
              style={{ backgroundColor: '#5B216E' }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#156d65'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#5B216E'}
            >
